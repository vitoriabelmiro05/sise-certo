...
$estagio = mysqli_query( $conn, "SELECT * FROM estagio WHERE nome_orientador = '$_SESSION[professor]' and aprovacao = '1' and date_format(inicio_estagio, '%Y') = '$_SESSION[ano]' or date_format(fim_estagio, '%Y') = '$_SESSION[ano]' ; " );
...
<h1>COORDENAÇÃO DE PROGRAMAS DE ESTÁGIO</h1>
</header>
<div class='corpo'>
<h1 style='font-size: 2rem'>DECLARAÇÃO N $dado[numero]/$dado[ano]</h1>
<p>
