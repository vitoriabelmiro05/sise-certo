...
$query = mysqli_query($conn, "update estagio set nome_aluno= '$nome_aluno', matricula = '$matricula', nome_empresa= '$nome_empresa', inicio_estagio = '$inicio_estagio', fim_estagio= '$fim_estagio', carga_horaria= '$carga_horaria' where idestagio = '$idestagio'" );
